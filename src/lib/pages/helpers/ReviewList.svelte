...
{#if reviews.reviews && reviews.reviews.length > 0}
    ...
    <span class="white">
    <input disabled id="rating-avg" class='slider range-slider' type="range" name="rating" min="0.1" max="10" value='{reviews.stats.average_stars}' style="width: 100%" step='0.1' tabindex="-1" data-output="rating-desc-avg" />
